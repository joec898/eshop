...
/* User_Roles */
insert into user_roles (user_id, role_id) values('demo', 3);
insert into user_roles (user_id, role_id) values('demo', 2);
insert into user_roles (user_id, role_id) values('admin', 1);
insert into user_roles (user_id, role_id) values('admin', 2);
insert into user_roles (user_id, role_id) values('user', 3);
insert into user_roles (user_id, role_id) values('jowens3', 3);
insert into user_roles (user_id, role_id) values('kburns4', 1);
insert into user_roles (user_id, role_id) values('jshaw5', 1);
insert into user_roles (user_id, role_id) values('pgilbert6', 1);
insert into user_roles (user_id, role_id) values('jjacobs7', 3);
insert into user_roles (user_id, role_id) values('kbennett8', 1);
insert into user_roles (user_id, role_id) values('cmurphy9', 1);
